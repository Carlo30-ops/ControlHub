...
const AlertDialogDescription = React.forwardRef(({ className, children, ...props }, ref) => (_jsx(AlertDialogPrimitive.Description, { ref: ref, asChild: true, "data-slot": "alert-dialog-description", className: cn("text-muted-foreground text-sm", className), ...props, children: _jsx("div", { children: children }) })));
